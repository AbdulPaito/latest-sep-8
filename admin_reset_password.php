...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['current_password']) && isset($_POST['new_password']) && isset($_POST['confirm_password'])) {
        ...
        if ($new_password !== $confirm_password) {
            ...
            // Fetch the current password from the database for admin
            $stmt = $conn->prepare("SELECT password_admin FROM admins WHERE username_admin = ?");
            if ($stmt === false) {
            ...
            if ($admin && $current_password === $admin['password_admin']) {
